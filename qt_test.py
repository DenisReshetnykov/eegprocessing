...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        openFile = QtWidgets.QAction(QtGui.QIcon('icons/open.png'), 'Open', self)
        openFile.setShortcut('Ctrl+O')
        openFile.setStatusTip('Open new File')
        # openFile.triggered.connect(self.OpenFileDialog)

        self.spectralAnalysis = QtWidgets.QAction(QtGui.QIcon('icons/open.png'), 'Spectral', self)
        ...
        self.entropyAnalysis = QtWidgets.QAction(QtGui.QIcon('icons/open.png'), 'Entropy', self)
